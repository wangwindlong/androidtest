...
package net.wangyl.test.bluetooth;
...
public abstract class DeviceListPreferenceFragment extends
    ...
    // 从缓存的配对列表中获取设备 被创建一个preference 的 item
    ...
    // BluetoothEventManager中found发现设备后回调
    @Override
    public void onDeviceAdded(CachedBluetoothDevice cachedDevice) {
        if (mDevicePreferenceMap.get(cachedDevice) != null) { // 如果缓存中已经有则什么都不做
            return;
        }
     ...
     * 添加一个缓存的蓝牙设备到偏好设置中，创建CachedDevice
